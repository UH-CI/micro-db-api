...
app.post("/requests", async (req, res) => {
  ...
  req.body.permissions = [
    { username: "seanbc", permissions: "ALL" },
    { username: "ikewai-admin", permissions: "ALL" },
    { username: "microdb-admin", permissions: "ALL" },
    { username: "ckkondo", permissions: "ALL" },
  ];
  ...
  const options = {
    ...
    headers: {
      ...
      Authorization: "Bearer 17a828eb8ba3e65bfb3b6e438752b5e4",
    },
  };
...
app.get("/email", async (req, res) => {
  ...
  const msg = {
    to: "ckkondo@hawaii.edu", // Change to your recipient
    from: "chuckeekondo@gmail.com", // Change to your verified sender
  ...
  //   port: 587,
  //   auth: {
  //     user: "chuckeekondo@gmail.com",
  //     pass: "**sqST+D5&FnMnuww2rfazfsz",
  //   },
  // };
  ...
  // await handleReq(req, res, permission, async (reqData) => {
  //   console.log("hello? ");
  //   let email = '"Chaz" <chuckeekondo@gmail.com>, "chaz2" <ckkondo@hawaii.edu';
  //   let data = "test";
